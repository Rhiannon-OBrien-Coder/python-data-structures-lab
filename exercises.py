...
# Use a for loop to iterate over the key: value pairs in the home_town dictionary and append a string
# with the following format to home_town_items: "<key> = <value>"
